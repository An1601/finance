...
import { handleResetCreateLoan } from "@redux/createLoanReducer";
...
const CreateLoan = () => {
  ...
  const handleSubmitForm = async (data: any) => {
    if (loanData.selectedForm) {
      try {
        toggleLoading(true);
        const loanResp = await handleSubmitLoan(data, loanData.selectedForm);
    ...
    } else toast.info(t("createLoanForm.selectWarning"));
  };
